...
void GraphL_NO::insert_into_myList(int w_start, int w_end, int e_value)
{
...
void GraphL_NO::printWithValues()
{
	for (int i = 0; i < vertsNum; i++) {
		cout << i << "  ";
		if (myList[i] != NULL) {
...
void GraphL_NO::saveToFile(string fileName)		//NOT ORIENTED, dziala
{
	fstream wyniki;
